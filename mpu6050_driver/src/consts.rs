...
pub mod FIFO_COUNT_H {
    pub const ADDR: u8 = 0x72;
    pub const FIFO_CNT_BITS: BitBlock = BitBlock { start: 0, len: 5 };
}

pub mod FIFO_COUNT_L {
    pub const ADDR: u8 = 0x73;
    pub const FIFO_CNT_BITS: BitBlock = BitBlock { start: 0, len: 8 };
}

pub mod FIFO_R_W {
    pub const ADDR: u8 = 0x74;
    pub const D_BITS: BitBlock = BitBlock { start: 0, len: 8 };
}
